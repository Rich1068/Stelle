...
<h2>@if($user->profile_picture == null)<img src="{{ asset('assets/images/default.jpg') }}" alt="Profile pic" style="max-width: 200px; max-height: 100px;"> @else <img src="{{ asset("{$user->profile_picture}") }}" alt="Profile pic" style="max-width: 200px; max-height: 100px;"> @endif{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }}</h2>
