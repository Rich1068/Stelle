    ...
    <div class="fpassword-container text-center w-100" style="max-width: 400px;">
        ...
        <div class="flex items-center justify-between"> <!-- Removed additional vertical spacing here -->
            <form method="POST" action="{{ route('verification.send') }}">
                ...
                <div>
                    <button class="resetpass" style="width: 200px; height: 50px; padding: 0; background-color: #1E3A8A; color: white; border-radius: 5px; font-weight: bold; text-align: center; cursor: pointer; border: none;">
