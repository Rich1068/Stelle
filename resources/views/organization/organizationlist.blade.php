...
<div id="event-list-container">
    @include('organization.partials.organizationlist', ['organizations' => $organizations]) <!-- Separate partial for events -->
</div>
...
<script>
    document.getElementById('eventSearch').addEventListener('input', function () {
        ...
        $.ajax({
            url: '{{ route("organization.list") }}', // Adjust this route to your organization listing route
            type: 'GET',
